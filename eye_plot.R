...
df_ref_raw_with_tags <- read_tsv(
  "02_results/ref_raw_with_tags.txt",
  show_col_types = FALSE
)
df_eye_property <- read_tsv(
  "02_results/eye_property.txt",
  show_col_types = FALSE
)
...
f10_view_eye_sliced_wfm <- function(tag = NA, cnt = 4) {
  ...
  print(ggp_start)
  html_name <- str_c(p_fig, "f10_view_sliced_wfm_start.html")
  ...
  print(ggp_end)
  html_name <- str_c(p_fig, "f10_view_sliced_wfm_end.html")
...
f10_ggplot_eye_and_wfm <- function(
  ...
  print(p)
  fig_name <- str_c(p_fig, "f10_ggplot_eye.png")
...
f10_ggmatplot_eye_and_wfm <- function(
  ...
  p <- l$p_wfm +
    ...
    plot_layout(design = design)
  # print(p)
  fig_name <- str_c(p_fig, "f10_ggmatplot_eye.png")
  ggsave(fig_name, p, width = 10, height = 6)
  message("save to ", fig_name)
  return(p)
}
...
dev.print(pdf, file = str_c(p_fig, "f10_matplot_eye.pdf"))
